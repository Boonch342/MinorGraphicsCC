Game.registerMod("cws-consistentUpgradeBuildingIcons", {
    ...
    // I'm lying it's super easy
		// creating shorthand variable "custImg" to refer to this
		var custImg = "https://raw.githubusercontent.com/Boonch342/MinorGraphicsCC/main/PillarRuler.png";
		...
		Game.Achievements['Oft we mar what\'s well'].icon = [9, 18]; //WAIT UNTIL V2.05!!!
		...
		Game.Achievements['Septcentennial'].icon = [1,7,custImg]; //WAIT UNTIL V2.05!!!
		
		// now the buildings i guess
